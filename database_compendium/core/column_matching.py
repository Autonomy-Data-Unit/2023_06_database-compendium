...
def scoreConnections(metadata_df, cols_list, method="", rare=True):
...
def formatForD3(titles, scoredConnections, cutoff=0, save=False, saveName=""):
    """
    ...
    id_df = pd.DataFrame({"Title": titles, "id": [x for x in range(len(titles))]})
